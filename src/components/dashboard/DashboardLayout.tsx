...
const DashboardLayout = ({ children, role, userName = "John Doe", userEmail = "john@example.com" }: DashboardLayoutProps) => {
  ...
  const roleConfig = {
    teacher: {
      ...
      navigation: [
        ...
        { name: "Applications", href: `/dashboard/${role}/applications`, icon: BookOpen },
    ...
    school: {
      ...
      navigation: [
        ...
        { name: "Messages", href: `/dashboard/${role}/messages`, icon: MessageSquare },
        { name: "School Profile", href: `/dashboard/${role}/profile`, icon: Building2 },
      ]
    },
    recruiter: {
      name: "Recruiter",
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                <DropdownMenuItem asChild>
                  <Link to={`/dashboard/${role}/profile`} className="cursor-pointer">

...
export default function AdminResourceManagement() {
  ...
  const filteredResources = mockResources.filter(resource => {
    ...
    const matchesSubject = subjectFilter === "all" || resource.subject.toLowerCase() === subjectFilter;
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Moderate and manage all platform resources</p>
        </div>
      </div>
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        This will permanently delete {selectedResources.length} selected resource(s). 
                ...
                {filteredResources.map((resource) => (
                  <TableRow key={resource.id}>
                    ...
                    <TableCell>
                      ...
                      <div className="text-sm text-muted-foreground">{resource.subject}</div>
                    </TableCell>
                    <TableCell>

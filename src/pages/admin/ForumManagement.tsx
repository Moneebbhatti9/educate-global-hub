  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          <h1 className="font-heading font-bold text-3xl text-foreground">Forum Management</h1>
          <p className="text-muted-foreground mt-2">
            Manage forum discussions, moderate content, and oversee community interactions
          </p>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-xl font-bold">{stats.reportedDiscussions}</p>
              </div>
            </div>
          </CardContent>
        </Card>
                ...
                <div className="flex items-start space-x-4 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center space-x-2 mb-1">
                      ...
                      {discussion.reports > 0 && <Flag className="w-4 h-4 text-red-500" />}

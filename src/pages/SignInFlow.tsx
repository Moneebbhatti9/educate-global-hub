...
const SignInFlow = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const userCredentials = testCredentials[email as keyof typeof testCredentials];
      ...
      if (userCredentials && userCredentials.password === password) {
        ...
        toast({
          ...
          description: "Please check your email and password, or try one of the test accounts: teacher@gmail.com, school@gmail.com, recruiter@gmail.com, or supplier@gmail.com",
          variant: "destructive"
        });
      }
    }, 2000);

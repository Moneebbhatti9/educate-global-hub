...
const SchoolDashboard = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case "Active": return "bg-brand-accent-green text-white";
      case "Draft": return "bg-yellow-500 text-white";
      case "Interview Scheduled": return "bg-brand-secondary text-white";
      case "Under Review": return "bg-brand-primary text-white";
      case "New Application": return "bg-brand-accent-orange text-white";
      default: return "bg-muted text-muted-foreground";
    }
  };

  return (
    <DashboardLayout role="school" userName="International School Dubai" userEmail="admin@isdubai.edu">
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your recruitment activities and connect with qualified educators.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="font-heading text-xl">Active Job Postings</CardTitle>
              ...
              <CardContent className="space-y-4">
                {jobPostings.map((job) => (
                  <div key={job.id} className="p-4 border border-border rounded-lg hover:border-brand-primary/30 hover:shadow-sm transition-all">
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-heading text-lg">Recent Candidates</CardTitle>
                <CardDescription>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-heading text-lg">Hiring Analytics</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>

...
import { Upload, X, Plus, Eye, DollarSign, FileText, Image as ImageIcon, Save, Send } from "lucide-react";
...
const resourceSchema = z.object({
  title: z.string().min(1, "Title is required").max(140, "Title must be under 140 characters"),
  shortDescription: z.string().min(140, "Short description must be at least 140 characters").max(300, "Short description must be under 300 characters"),
...
const RESOURCE_TYPES = [
  "Worksheet", "Lesson Plan", "Presentation", "Assessment", "Scheme of Work", "Display", "Activity", "Game", "Video", "Other"
];

const SUBJECTS = [
  "Mathematics", "English", "Science", "History", "Geography", "Art", "Music", "PE", "Computing", "Languages", "PSHE", "Religious Studies"
];

const AGE_GROUPS = [
  "Early Years (2-5 years)", "Key Stage 1 (5-7 years)", "Key Stage 2 (7-11 years)", 
...
const LICENSE_TYPES = [
  "Single Teacher License", "School License", "Multiple Use License", "Commercial License"
];
...
const UploadResource = () => {
  ...
  const handlePreviewUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (previewImages.length + files.length > maxFiles) {
      toast({
        ...
        description: `${isPaid ? "Paid" : "Free"} resources can have maximum ${maxFiles} preview image${maxFiles > 1 ? "s" : ""}`,
        variant: "destructive"
      });
      return;
    }
  ...
  const handleResourceFilesUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    const files = Array.from(e.target.files || []);
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            <nav className="text-sm text-muted-foreground mb-4">
              Home / My Resources / Create Resource
            </nav>
            <h1 className="text-3xl font-bold text-foreground">Create a Resource</h1>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Recommended: 1200×400px (16:5), min 800×300px, JPEG/PNG, max 5MB
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-4 text-center">
                          <label htmlFor="preview-upload" className="cursor-pointer">
                            ...
                            <span className="text-sm text-primary hover:underline">Add Preview Images</span>
                            <input
                              id="preview-upload"
                              type="file"
                              accept="image/*"
                        ...
                        <p className="text-xs text-muted-foreground">
                          Screenshots of worksheets, slides, or sample pages. 1200×825px recommended, max 3MB each
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-4 text-center">
                          <label htmlFor="resource-upload" className="cursor-pointer">
                            ...
                            <span className="text-sm text-primary hover:underline">Upload Resource Files</span>
                            <input
                              id="resource-upload"
                              type="file"
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription>
                              {field.value?.length || 0}/300 characters (140-300 required)
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription>
                              Include headings, bullet points, learning outcomes, and requirements.
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
                        ...
                        <div className="space-y-4 border border-border rounded-lg p-4">
                                ...
                                <FormItem>
                                  ...
                                  {watchPrice && watchPrice < 3 && (
                                    <p className="text-sm text-amber-600">
                                      ⚠️ Items under £3 incur a transaction fee of £0.20
                                    </p>
                                  )}
                                  <FormMessage />
                                </FormItem>
                          ...
                          <div className="bg-muted/50 p-3 rounded-lg space-y-2">
                            <div className="flex justify-between text-sm">
                              ...
                              <Badge variant="secondary">{currentRoyaltyTier}</Badge>
                            </div>
                            <div className="flex justify-between text-sm">
                            ...
                            <p className="text-xs text-muted-foreground">
                              Your share after VAT, transaction fees, and platform commission
                            </p>
                          </div>
                        </div>
                      )}

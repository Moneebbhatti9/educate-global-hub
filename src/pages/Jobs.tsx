...
const Jobs = () => {
  ...
  const jobs = [
    {
      ...
      posted: "2 days ago",
      description:
        "Seeking an enthusiastic Mathematics teacher for Key Stage 3 & 4 students.",
      subjects: ["Mathematics", "Statistics"],
      benefits: [
        "Health Insurance",
    ...
    },
    {
      ...
      posted: "1 week ago",
      description:
        "Lead the English department and develop curriculum for grades 6-12.",
      subjects: ["English", "Literature", "Creative Writing"],
      benefits: [
        "Tax-free Salary",
        "Flights",
    ...
    },
    {
      ...
      posted: "3 days ago",
      description:
        "Teach Biology and Chemistry to high school students in a diverse environment.",
      subjects: ["Biology", "Chemistry", "Environmental Science"],
      benefits: [
        "Professional Development",
        "Local Transport",
    ...
    },
    {
      ...
      posted: "1 week ago",
      description:
        "Lead our innovative music program and inspire young musicians.",
      subjects: ["Music", "Performance", "Music Theory"],
      benefits: [
        "Leadership Role",
        "Creative Freedom",
  ...
  const filteredJobs = jobs.filter((job) => {
    ...
    const matchesContinent =
      selectedContinent === "all" || job.continent === selectedContinent;
    ...
    return (
      matchesSearch && matchesContinent && matchesJobType && matchesCountry
    );
  });

...
const SchoolProfile = () => {
  ...
  const [profile, setProfile] = useState({
    ...
    curriculum: ["International Baccalaureate", "American Curriculum", "Advanced Placement"],
    schoolSize: "Large (1001+ students)",
    schoolType: "International",
    genderType: "Mixed",
    ageGroup: ["Primary (6-11 years)", "Secondary (12-16 years)", "Sixth Form/High School (17-18 years)"],
    aboutSchool: "Lincoln International Academy is a premier educational institution committed to fostering global citizenship and academic excellence. Our diverse community of learners represents over 40 nationalities, creating a rich multicultural environment that prepares students for success in an interconnected world.",
    mission: "To provide an exceptional international education that develops inquiring, knowledgeable, and caring young people who help to create a better and more peaceful world through intercultural understanding and respect.",
    vision: "To be a leading international school that inspires students to achieve their full potential and become responsible global citizens."
  });
        ...
        <div className="max-w-6xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xl text-muted-foreground mb-3">
                    {profile.schoolType} • {profile.schoolSize} • Est. {profile.schoolInfo.establishedYear}
                  </p>
                  <p className="text-foreground max-w-3xl mb-4">{profile.aboutSchool}</p>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 h-auto p-1">
              ...
              <TabsTrigger value="school-info" className="text-xs sm:text-sm">School Info</TabsTrigger>
            ...
            <TabsContent value="overview" className="space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="font-heading text-lg">School Overview</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-muted-foreground">Established</span>
                      <span className="font-semibold">{profile.schoolInfo.establishedYear}</span>
                    </div>
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-brand-accent-green">92%</span>
                    </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm">{profile.schoolInfo.schoolContactNumber}</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Mail className="w-4 h-4 text-muted-foreground" />
                      <span className="text-sm">{profile.schoolInfo.schoolEmail}</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      ...
                      <div key={index} className="p-4 border rounded-lg hover:shadow-md transition-shadow">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">Ages 6-18</p>
                          </div>
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {profile.ageGroup.map((age, index) => (
                      <div key={index} className="text-center p-4 border rounded-lg">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">250+ students</p>
                      </div>
                    ))}
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      ...
                      <div>
                        <Label htmlFor="schoolContactNumber">Primary Contact *</Label>
                        <Input 
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <Select>
                          <SelectTrigger>
                            <SelectValue placeholder={profile.schoolInfo.country} />
                          </SelectTrigger>
                          <SelectContent>
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-4">School Classification</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                      ...
                      <div>
                        ...
                        <Select>
                          ...
                          <SelectContent>
                            <SelectItem value="small">Small (1-500 students)</SelectItem>
                            <SelectItem value="medium">Medium (501-1000 students)</SelectItem>
                            <SelectItem value="large">Large (1001+ students)</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div>
                  ...
                  {/* About School */}
                  <div>
                    <h3 className="font-semibold text-lg mb-4">About the School</h3>
                    <div className="space-y-4">
                      <div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mt-2">
                        {[
                          ...
                          <div key={index} className="flex items-center space-x-2">
                            ...
                            />
                            <Label htmlFor={`curr-${index}`} className="text-sm">{curr}</Label>
                          </div>
                        ))}
                      </div>
                    </div>
                        ...
                        {[
                          ...
                          <div key={index} className="flex items-center space-x-2">
                            <input 
                              ...
                              className="rounded border-border"
                            />
                            <Label htmlFor={`age-${index}`} className="text-sm">{age}</Label>
                          </div>
                        ))}
                      </div>
                    </div>
            ...
            <TabsContent value="facilities" className="space-y-6">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">School facilities and infrastructure details...</p>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="staff" className="space-y-6">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">Staff and faculty management section...</p>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="admissions" className="space-y-6">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">Admissions process and requirements section...</p>
                </CardContent>
              </Card>
            </TabsContent>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="border-2 border-dashed border-muted rounded-lg p-8 text-center">
                        ...
                        <p className="text-muted-foreground mb-4">Upload school photos and campus images</p>
                        <Button variant="outline">
                          Choose Images
                        </Button>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="border-2 border-dashed border-muted rounded-lg p-8 text-center">
                        ...
                        <p className="text-muted-foreground mb-4">Upload brochures, handbooks, and other documents</p>
                        <Button variant="outline">
                          Choose Files
                        </Button>
                      </div>
